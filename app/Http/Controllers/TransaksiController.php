    ...
    public function index(Request $request)
{
    ...
    // Search berdasarkan kode transaksi, nama anggota, atau judul buku
    ...
    // Filter status (opsional, sekalian ditambahkan)
    ...
    public function update(Request $request, string $id)
{
    ...
    try {
        DB::transaction(function () use ($request, $id) {
            ...
            // Dipinjam -> Dikembalikan: hitung denda & kembalikan stok
            if ($statusLama === 'Dipinjam' && $statusBaru === 'Dikembalikan') {
                $tanggalDikembalikan = now();
                $dataUpdate['tanggal_dikembalikan'] = $tanggalDikembalikan->toDateString();
                $dataUpdate['denda'] = $this->hitungDenda($transaksi, $tanggalDikembalikan);
                $transaksi->buku->increment('stok');
            }

            // Dikembalikan -> Dipinjam (dibatalkan): kurangi stok lagi
 ...
 */
    ...
    private function hitungDenda($transaksi, $tanggalDikembalikan)
    {
        ...
        $hariTerlambat = $hariIni->diffInDays($batasKembali, true);
