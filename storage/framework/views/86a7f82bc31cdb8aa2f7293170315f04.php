...
<body class="p-4">
    ...
    <div class="container">
        ...
        <div class="text-center mb-4">
            ...
            <p class="m-0 mt-1" style="font-size: 13px;">Waktu Cetak: <?php echo e(date('d F Y H:i')); ?> WIB</p>
        </div>
        ...
        <div class="mb-3" style="font-size: 14px;">
            <table class="table table-borderless w-auto m-0 p-0" style="line-height: 1.5;">
                <tr>
                    ...
                    <td class="p-0 fw-bold" style="border:none !important;"><?php echo e($totalTransaksi); ?> Eksemplar</td>
                </tr>
                <tr>
                    <td class="p-0 pe-3 fw-bold" style="border:none !important;">Total Akumulasi Denda</td>
                    <td class="p-0 pe-2" style="border:none !important;">:</td>
                    <td class="p-0 fw-bold" style="border:none !important;">Rp <?php echo e(number_format($totalDenda, 0, ',', '.')); ?></td>
                </tr>
            </table>
        </div>
        ...
        <table class="table table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center fw-bold"><?php echo e($transaksi->kode_transaksi); ?></td>
                    <td><?php echo e($transaksi->anggota->nama ?? '-'); ?></td>
                    <td><?php echo e($transaksi->buku->judul ?? '-'); ?></td>
                    <td class="text-center"><?php echo e(\Carbon\Carbon::parse($transaksi->tanggal_pinjam)->format('d/m/Y')); ?></td>
                    <td class="text-center"><?php echo e(\Carbon\Carbon::parse($transaksi->tanggal_kembali)->format('d/m/Y')); ?></td>
                    <td class="text-center"><?php echo e($transaksi->status); ?></td>
        ...
        <div class="clearfix">
            <div class="ttd-container">
                <p class="m-0">Kota Baru, <?php echo e(date('d F Y')); ?></p>
...
</html><?php /**PATH C:\xampp\htdocs\Pertemuan 15\praktikum-Pertemuan15\resources\views/transaksi/laporan_pdf.blade.php ENDPATH**/ ?>